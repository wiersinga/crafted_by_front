        ...
        <div class="containerAccount">
            ...
            <p class="text-sm flex justify-center font-light text-gray-500 dark:text-gray-400">
                Vous êtes un nouvel utilisateur? <RouterLink to="/register"
                    class="font-medium text-primary-600 hover:underline dark:text-primary-500"> Créer un compte.
                </RouterLink>
            </p>
                ...
                <form class="space-y-4 md:space-y-6" action="#" @submit.prevent="login">
                    <div>
                        ...
                        <input type="email" name="email" id="email" v-model="email"
                            ...
                            <span v-if="emailError" class="text-danger text-red">{{ emailError }}</span>
                    </div>
                    <div class="py-2">
                        <label for="password" class="block mb-2 text-sm font-medium text-black dark:text-white">Mot
                            de passe</label>
                        <div class="relative">
                            ...
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center text-sm leading-5">
                                ...
                                <svg class="h-6 cursor-pointer" @click="togglePassword"
                    ...
                    <div class="flex justify-center">
                        <Button name="Se connecter" backgroundColor="#B31414" type="submit" @click="handleLogin" />
                    </div>
...
async function handleLogin() {
  try {
    ...
    serverError.value = "Erreur de connexion au serveur. Veuillez réessayer.";
  }
}
...
//           } else {
//             serverError.value = 'Erreur lors de la connexion.';
//           }
//         } catch (error) {
