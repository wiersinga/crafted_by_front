         ...
         <div class="mt-5 bg-white rounded-lg shadow">
            <div class="flex">
               <div class="flex-1 py-5 pl-5 overflow-hidden">
                  ...
                  <h1 class="inline text-2xl font-semibold leading-none">Adresse d'envoi</h1>
               </div>
            </div>
            <div class="px-5 pb-5">
               ...
               <div class="flex items-center pt-3"><input type="checkbox" class="w-4 h-4 text-black bg-gray-300 border-none rounded-md focus:ring-transparent"><label for="safeAdress" class="block ml-2 text-sm text-gray-900">Marquer comme adresse de facturation</label></div>
            </div>
